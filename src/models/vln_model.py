...
class CustomBERTModel(nn.Module):
    def __init__(self, model_name_or_path=None, local_files_only=False):
        super(CustomBERTModel, self).__init__()
        model_name_or_path = model_name_or_path or os.environ.get("BERT_MODEL_PATH", "bert-base-uncased")
        self.bert = AutoModel.from_pretrained(model_name_or_path, local_files_only=local_files_only)
