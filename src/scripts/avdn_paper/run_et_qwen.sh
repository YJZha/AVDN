...
#      --submit True
# resume
CUDA_VISIBLE_DEVICES='0'  python xview_et/main.py --output_dir $DATASET_DIR/AVDN/et_qwen_2 $flag \
      --resume_file $DATASET_DIR/AVDN/et_qwen_1/ckpts/latest_dict_32116
